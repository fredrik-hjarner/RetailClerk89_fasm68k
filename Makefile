...
diff:
	git diff --unified=0 --no-index vasm_artifacts/RetailClerk.hex fasm68k_artifacts/RetailClerk.hex

diff-count:
	git diff --unified=0 --no-index vasm_artifacts/RetailClerk.hex fasm68k_artifacts/RetailClerk.hex | wc -l
